---
mode: subagent
description: "Builds and runs CUTLASS conv2d test harness, reports PASS/FAIL to Manager"
...
permission:
  ...
  bash:
    "nvcc *": allow
    "source scripts/cutlass.env": allow
    "/tmp/conv2d_test": allow
    "*": deny
---
...
5. **Do NOT modify any source files** — only read and execute.
